const CONFIG = {
  ...
  NOTICE_BAR: [
    { title: '图片如未加载 请刷新！', url: '/sponsor' },
    { title: '赞助我们', url: 'sponsor' }
  ],

  // 英雄区(首页顶部大卡)
  HERO_TITLE_1: '知识无价',
  HERO_TITLE_2: '开源共享',
  HERO_TITLE_3: 'https://nuaa.store',
  HERO_TITLE_4: '新版上线',
  HERO_TITLE_5: 'NUAA-AI 协助计划',
  HERO_TITLE_LINK: 'https://nuaa.chat',

  // 英雄区显示三个置顶分类
  HERO_CATEGORY_1: { title: '科目合集', url: '/subject' },
  HERO_CATEGORY_2: { title: '常用教程', url: '/tutorial' },
  HERO_CATEGORY_3: { title: '通识认知', url: '/general' },
  ...
  INFO_CARD_URL: 'https://b3ndan.com', // 个人资料底部按钮链接
  ...
  SOCIAL_CARD_TITLE_1: 'NUAA 知识库',
  SOCIAL_CARD_TITLE_2: '你想问的这里都有~',
  SOCIAL_CARD_TITLE_3: '点击访问',
  SOCIAL_CARD_URL: 'https://nuaa.wiki',
